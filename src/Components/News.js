  ...
  static propTypes={
   ...
   async updateInfo(){
    ...
    handleNext=async()=>{
      ...
      let apiUrl=`https://newsapi.org/v2/top-headlines?category=${this.props.category}&country=${this.props.country}&apiKey=${this.props.apiKey}
